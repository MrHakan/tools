...
window.BENCH_TOOLS = [
  ...
  { slug: "habit-tracker", cat: "Productivity", spec: "▮▮▮▮▮▯▮", name: "Habit Tracker",
  ...
  { slug: "expense-splitter", cat: "Productivity", spec: "A → B  $24.00", name: "Expense Splitter",
  ...
  { slug: "timezone-finder", cat: "Productivity", spec: "UTC+3 ⇄ UTC−5", name: "Time Zone Finder",
  ...
  { slug: "timestamp-converter", cat: "Developer utilities", spec: "1754092800", name: "Timestamp Converter",
    blurb: "Unix time to readable dates and back, in any zone.", keys: "unix epoch date time iso8601 seconds millis" },
  { slug: "base-converter", cat: "Developer utilities", spec: "0xFF = 255", name: "Number Base Converter",
  ...
  { slug: "gitignore-generator", cat: "Developer utilities", spec: "node_modules/", name: ".gitignore Generator",
  ...
  { slug: "patch-generator", cat: "Developer utilities", spec: "@@ -1,4 +1,6 @@", name: "Patch Generator",
    blurb: "Produce a unified diff you can feed to git apply.", keys: "unified diff patch apply hunk git" },
  { slug: "word-diff", cat: "Developer utilities", spec: "~~was~~ **is**", name: "Word-level Diff",
  ...
  { slug: "contrast-checker", cat: "Design & CSS", spec: "4.5 : 1  AA", name: "Contrast Checker",
  ...
  { slug: "clamp-calculator", cat: "Design & CSS", spec: "clamp(1rem, 2vw, 2rem)", name: "Clamp Calculator",
    blurb: "Fluid type and spacing as a single clamp() value.", keys: "responsive typography fluid viewport rem scale" },
  { slug: "aspect-ratio", cat: "Design & CSS", spec: "16 : 9", name: "Aspect Ratio Calculator",
  ...
  { slug: "placeholder-image", cat: "Design & CSS", spec: "600 × 400", name: "Placeholder Image",
  ...
  { slug: "keyword-highlighter", cat: "Content & text", spec: '"term" ×14', name: "Keyword Highlighter",
